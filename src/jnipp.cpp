...
namespace jni {
    ...
    inline void handleJavaExceptions() {
        JNIEnv *env = jni::env();
    ...
    inline std::string toString(jobject handle, bool deleteLocal = true) {
        std::string result;
    ...
    inline std::wstring toWString(jobject handle, bool deleteLocal = true) {
        std::wstring result;
    ...
    Object::Object(jobject ref, int scopeFlags) : _handle(ref), _class(nullptr),
                                                  _isGlobal((scopeFlags & Temporary) == 0) {
        if (!_isGlobal)
            return;
    ...
    byte_t Object::callMethod(method_t method, internal::value_t *args,
    ...
    wchar_t Object::callMethod(method_t method, internal::value_t *args,
    ...
    short Object::callMethod(method_t method, internal::value_t *args,
    ...
    long long Object::callMethod(method_t method, internal::value_t *args,
    ...
    float Object::callMethod(method_t method, internal::value_t *args,
    ...
    double Object::callMethod(method_t method, internal::value_t *args,
    ...
    std::string Object::callMethod(method_t method, internal::value_t *args,
    ...
    std::wstring Object::callMethod(method_t method, internal::value_t *args,
    ...
    jni::Object Object::callMethod(method_t method, internal::value_t *args,
    ...
    jarray Object::callMethod(method_t method, internal::value_t *args,
    ...
    template<>
    Array<std::string>::Array(long length) : Object(env()->NewObjectArray(
                                                 length, Class("java/lang/String").getHandle(), nullptr)),
                                             _length(length) {}

    template<>
    Array<std::wstring>::Array(long length) : Object(env()->NewObjectArray(
                                                  length, Class("java/lang/String").getHandle(), nullptr)),
                                              _length(length) {}

    template<>
    Array<Object>::Array(long length) : Object(env()->NewObjectArray(length, Class("java/lang/Object").getHandle(),
                                                                     nullptr)), _length(length) {}

    template<>
    Array<Object>::Array(long length, const Class &type) : Object(env()->NewObjectArray(
    ...
    static std::string detectJvmPath() {
        ...
        if (::RegOpenKeyA(HKEY_LOCAL_MACHINE, "Software\\JavaSoft\\Java Runtime Environment\\", &versionKey) ==
            ERROR_SUCCESS) {
            if (::RegQueryValueEx(versionKey, "CurrentVersion", NULL, NULL, buffer, &size) == ERROR_SUCCESS) {
                HKEY libKey;

                std::string keyName = std::string("Software\\JavaSoft\\Java Runtime Environment\\") + (const char *)
                                      buffer;

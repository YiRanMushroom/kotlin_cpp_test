...
namespace jni {
    ...
    namespace internal {
        ...
        struct valueSigImpl {
            static std::string getValueSig() {
                return T::getValueSig();
            }
        };

        template<typename T>
        std::string valueSig(const T *) {
            return valueSigImpl<T>::getValueSig();
        }

        template<>
        inline std::string valueSig<void>(const void *) { return "V"; }

        template<>
        inline std::string valueSig<bool>(const bool *) { return "Z"; }

        template<>
        inline std::string valueSig<byte_t>(const byte_t *) { return "B"; }

        template<>
        inline std::string valueSig<wchar_t>(const wchar_t *) { return "C"; }

        template<>
        inline std::string valueSig<short>(const short *) { return "S"; }

        template<>
        inline std::string valueSig<int>(const int *) { return "I"; }

        template<>
        inline std::string valueSig<long long>(const long long *) { return "J"; }

        template<>
        inline std::string valueSig<float>(const float *) { return "F"; }

        template<>
        inline std::string valueSig<double>(const double *) { return "D"; }

        template<>
        inline std::string valueSig<std::string>(const std::string *) { return "Ljava/lang/String;"; }

        template<>
        inline std::string valueSig<std::wstring>(const std::wstring *) { return "Ljava/lang/String;"; }

        template<>
        inline std::string valueSig<const char *>(const char * const *) { return "Ljava/lang/String;"; }

        template<>
        inline std::string valueSig<const wchar_t *>(const wchar_t * const *) { return "Ljava/lang/String;"; }
        ...
        template<class TArg>
        struct valueSigImpl<Array<TArg>> {
            static std::string getValueSig() {
        ...
        template<class TArg>
            requires requires {
                { TArg::getValueSig() } -> std::convertible_to<std::string>;
            }
        inline std::string valueSig(const TArg *) {
            return TArg::getValueSig();
        }
        ...
        public:
            ArgArray(const TArgs &... args) {
                std::memset(static_cast<void*>(this), 0, sizeof(ArgArray<TArgs...>));
        ...
        public:
            ArgArray() {
                std::memset(static_cast<void*>(this), 0, sizeof(ArgArray<>));
            }
    ...
    private:
        ...
        wchar_t callMethod(method_t method, internal::value_t *args,
        ...
        long long callMethod(method_t method, internal::value_t *args,
        ...
        std::string callMethod(method_t method, internal::value_t *args,
                               internal::ReturnTypeWrapper<std::string> const &) const;

        std::wstring callMethod(method_t method, internal::value_t *args,
                                internal::ReturnTypeWrapper<std::wstring> const &) const;

        jni::Object callMethod(method_t method, internal::value_t *args,
        ...
        template<typename T>
        jni::Array<T> callMethod(method_t method, internal::value_t *args,
    ...
    private:
        ...
        template<class TType>
        TType callExactMethod(jobject obj, method_t method, internal::value_t *values) const;
...
namespace jni {
    template<typename T>
    Array<T>::Array(long length, const Class &type) : Object(env()->NewObjectArray(
                                                          length, type.getHandle(), nullptr)), _length(length) {
        static_assert(std::is_base_of<Object, T>::value, "T must be a subclass of Object");
    }

    template<typename T>
    T Array<T>::getElement(long index) const {
        static_assert(std::is_base_of<Object, T>::value, "T must be a subclass of Object");
        jobject output = env()->GetObjectArrayElement(jobjectArray(getHandle()), index);
        handleJavaExceptions();
        return T{Object(output, DeleteLocalInput)};
    }
}
